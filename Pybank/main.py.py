...
# Files to load and output (Using direct full paths)
file_to_load = "/python_challenge/PyBank/Resources/budget_data.csv"
file_to_output = "/python_challenge/PyBank/analysis/budget_analysis.txt"
